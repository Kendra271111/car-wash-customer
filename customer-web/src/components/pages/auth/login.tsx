...
const Login = () => {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-teal-50 p-4 sm:p-6 lg:p-10">
      <div className="flex w-full max-w-5xl overflow-hidden rounded-[2rem] bg-white shadow-xl shadow-teal-900/5">
        {/* ── Left: form ── */}
        <div className="flex w-full flex-col justify-between p-8 sm:p-10 lg:w-1/2 lg:p-12">
          <div>
            ...
            {error && (
              <div
                role="alert"
                className="mt-6 flex items-start gap-2 rounded-xl bg-red-50 px-3 py-2.5 text-sm text-red-600"
              >
            ...
            <form onSubmit={onSubmit} className="mt-8 space-y-4">
              <div>
                <input
                  ...
                  className="w-full rounded-2xl border-0 bg-slate-100 px-4 py-3.5 text-sm text-slate-900 outline-none ring-0 placeholder:text-slate-400 focus:bg-slate-100 focus:ring-2 focus:ring-teal-500/40"
                />
              </div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full rounded-2xl border-0 bg-slate-100 px-4 py-3.5 pr-12 text-sm text-slate-900 outline-none placeholder:text-slate-400 focus:ring-2 focus:ring-teal-500/40"
                />
                <button
                  type="button"
              ...
              <button
                ...
                className="mt-2 flex w-full items-center justify-center rounded-2xl bg-slate-900 py-3.5 text-sm font-semibold text-white transition hover:bg-slate-800 disabled:cursor-not-allowed disabled:bg-slate-300"
              >
                {loading ? (
        ...
        <div className="relative hidden min-h-[560px] w-1/2 overflow-hidden lg:block">
          ...
          <div className="absolute inset-x-8 bottom-10 rounded-2xl border border-white/20 bg-white/15 p-6 backdrop-blur-md">
