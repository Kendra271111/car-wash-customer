...
const fieldClass =
  'w-full rounded-2xl border-0 bg-slate-100 px-4 py-3 text-sm text-slate-900 outline-none placeholder:text-slate-400 focus:ring-2 focus:ring-teal-500/40'
        ...
        <div className="flex w-full flex-col justify-between p-8 sm:p-10 lg:w-1/2 lg:p-12">
          <div>
            ...
            {error && (
              <div
                role="alert"
                className="mt-5 flex items-start gap-2 rounded-xl bg-red-50 px-3 py-2.5 text-sm text-red-600"
              >
            ...
            <form onSubmit={onSubmit} className="mt-6 space-y-3">
              ...
              <div className="relative">
                <input
                  ...
                  className={`${fieldClass} pr-12 ${
                    confirm && !passwordsMatch ? 'ring-2 ring-red-400' : ''
                  }`}
                />
                <button
                  type="button"
              ...
              <button
                type="submit"
                disabled={!canSubmit}
                className="mt-1 flex w-full items-center justify-center rounded-2xl bg-slate-900 py-3.5 text-sm font-semibold text-white transition hover:bg-slate-800 disabled:cursor-not-allowed disabled:bg-slate-300"
              >
                {loading ? (
